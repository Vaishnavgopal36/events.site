...
export const EventCard = memo(function EventCard({
  ...
  return (
    <article className="group relative overflow-hidden rounded-3xl border border-white/80 bg-white/85 p-5 shadow-lg shadow-purple-900/10 backdrop-blur transition-all duration-300 ease-out hover:-translate-y-2 hover:shadow-xl hover:shadow-teal-500/20">
      ...
      <button
        ...
        className="relative w-full cursor-pointer rounded-2xl bg-gradient-to-r from-fuchsia-500 via-purple-500 to-cyan-500 px-5 py-3 text-sm font-black text-white shadow-lg shadow-purple-900/25 transition-all duration-300 ease-out hover:scale-[1.02] hover:shadow-xl hover:shadow-purple-900/30 focus:outline-none focus:ring-4 focus:ring-purple-500/30 active:scale-95"
      >
        Book Event
      </button>
    </article>
